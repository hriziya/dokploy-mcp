...
const cleanUnusedVolumes = postTool({
  ...
  description: 'Remove unused Docker volumes. This action is irreversible and may delete data.',
  schema: z.object({}),
...
const cleanStoppedContainers = postTool({
  ...
  description: 'Remove all stopped Docker containers. This action is irreversible.',
  schema: z.object({}),
...
const cleanMonitoring = postTool({
  ...
  description: 'Clear all monitoring data. This action is irreversible.',
  schema: z.object({}),
...
const cleanSSHPrivateKey = postTool({
  ...
  description: 'Remove the stored SSH private key. This action is irreversible.',
  schema: z.object({}),
