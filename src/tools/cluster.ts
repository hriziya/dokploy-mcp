...
const addWorker = getTool({
  ...
  description: 'Get the command to add a new worker node to the Docker Swarm cluster.',
  schema: z.object({}),
...
const addManager = getTool({
  ...
  description: 'Get the command to add a new manager node to the Docker Swarm cluster.',
  schema: z.object({}),
...
const removeWorker = postTool({
  ...
  description: 'Remove a worker node from the Docker Swarm cluster. This action is irreversible.',
  schema: z.object({
